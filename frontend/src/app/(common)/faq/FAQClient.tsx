...
const faqs: FAQItem[] = [
  {
    question: "What is Go Automat Work ?",
    answer: "Go Automat Work is an automation platform that helps businesses streamline workflows, integrate tools, and save time.",
  },
  {
    question: "How does Go Automat Work save time?",
    answer: "It automates repetitive tasks such as data entry, reporting, and notifications so teams can focus on strategic work.",
  },
  {
    question: "Can Go Automat Work integrate with my CRM?",
    answer: "Yes, Go Automat Work integrates with popular CRMs like HubSpot, Salesforce, and Zoho.",
  },
  {
    question: "Do I need coding knowledge to use Go Automat Work ?",
    answer: "No, Go Automat Work is designed for non-technical users with an easy drag-and-drop interface.",
  },
  {
    question: "Is Go Automat Work secure?",
    answer: "Yes, Go Automat Work uses enterprise-grade encryption and complies with GDPR standards to keep your data safe.",
  },
  {
    question: "Can I try Go Automat Work for free?",
    answer: "Yes, we offer a free trial with limited features so you can test the platform before subscribing.",
  },
  {
    question: "What industries use Go Automat Work ?",
    answer: "Our clients include e-commerce, finance, healthcare, IT, real estate, and more.",
  },
  {
    question: "How many integrations does Go Automat Work support?",
    answer: "Go Automat Work integrates with over 200+ apps, including Google Workspace, Slack, and Shopify.",
  },
  {
    question: "Can Go Automat Work automate email campaigns?",
    answer: "Yes, Go Automat Work can automate email campaigns, drip sequences, and personalized communications.",
  },
  {
    question: "Does Go Automat Work provide analytics?",
    answer: "Yes, Go Automat Work includes detailed analytics dashboards to monitor performance and ROI.",
  },
  {
  ...
  {
    question: "Can Go Automat Work handle bulk data processing?",
    answer: "Yes, Go Automat Work is designed to process bulk data efficiently without performance drops.",
  },
  {
    question: "Is Go Automat Work mobile-friendly?",
    answer: "Yes, you can access and manage workflows from any mobile device.",
  },
  {
    question: "Does Go Automat Work replace employees?",
    answer: "No, Go Automat Work enhances productivity by handling repetitive tasks, allowing employees to focus on strategy and growth.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, Go Automat Work allows real-time collaboration with role-based access control.",
  },
  {
    question: "Does Go Automat Work support AI?",
    answer: "Yes, Go Automat Work uses AI to optimize workflows and suggest automation improvements.",
  },
  {
  ...
  {
    question: "Can Go Automat Work scale as my business grows?",
    answer: "Absolutely. Go Automat Work is built to scale with your needs, from startups to large enterprises.",
  },
  {
    question: "How can I contact support?",
    answer: "You can reach us via email at support@Go Automat Work.com or through the Contact Us page.",
  },
]
    ...
    <section className="py-28 px-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto
          ...
          Find answers to common questions about Go Automat Work. Use the search below to quickly find what you’re looking for.
        </p>
      </div>
