...
<head>
    ...
    <title>Automation Status - LoopAxis</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
                            ...
                            <div style="background-color: #f8f9fa; padding: 25px; border-radius: 8px; border-left: 4px solid ${config.color}; border: 1px solid #e9ecef;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 12px 0; color: #131D4F; font-size: 14px;">LoopAxis Admin Team</td>
                                    </tr>
                                    ` : ''}
                                    <tr>
    ...
    `;
        ...
        function getStatusMessage(status, instanceName) {
            const messages = {
        ...
        function getActionItems(status) {
            const actions = {
        ...
        function getCTAButtons(status) {
            ...
            `;
                ...
                return `
                <a href="https://loopaxis.babluverma.site/dashboard/services" 
                   style="background-color: #E6521F; color: white; padding: 14px 32px; 
                          text-decoration: none; border-radius: 6px; font-weight: bold; 
                          font-size: 15px; display: inline-block; margin: 5px;">
                    View Service
        ...
        const info = await nodemailer_1.email_transporter.sendMail({
            from: `LoopAxis Services <${nodemailer_1.sender_email}>`,
            to: email,
            subject,
            html
        });
