...
const sendInvoiceEmail = async (user, pdfBuffer, payment) => {
    try {
        const subject = `🧾 Invoice #${payment.orderId} - LoopAxis`;
        const html = `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 25px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="https://loopaxis.babluverma.site/dashboard/billing" 
                    ...
                    <tr>
                        <td style="padding-bottom: 10px;">
                            <p style="color: #131D4F; font-size: 14px; line-height: 1.6; margin: 0;">
                                ...
                                <a href="https://loopaxis.babluverma.site/contact" style="color: #E6521F; text-decoration: none;">Contact our support team</a> 
                                for assistance.
                            </p>
                        </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 20px;">
                            ...
                            <a href="https://loopaxis.babluverma.site/billing" style="color: #E6521F; text-decoration: none; margin: 0 12px; font-size: 14px;">Billing</a>
    ...
    `;
        const info = await nodemailer_1.email_transporter.sendMail({
            from: `LoopAxis Billing <${nodemailer_1.sender_email}>`,
            to: user.email,
            subject,
            html,
            attachments: [
