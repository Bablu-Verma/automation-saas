...
const sendAutomationExpirationEmail = async (email, username, instanceName, status) => {
    try {
        ...
        const subject = isExpiringSoon
            ? `⚠️ Automation "${instanceName}" Expiring Soon - LoopAxis`
            : `❌ Automation "${instanceName}" Has Expired - LoopAxis`;
        const statusConfig = {
            EXPIRE_SOON: {
                color: "#f39c12",
                icon: "⚠️",
...
<head>
    ...
    <title>Automation ${isExpiringSoon ? 'Expiring Soon' : 'Expired'} - LoopAxis</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa;">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 25px;">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="https://loopaxis.babluverma.site/dashboard/automations" 
                    ...
                    <tr>
                        <td style="padding-bottom: 10px;">
                            <p style="color: #131D4F; font-size: 14px; line-height: 1.6; margin: 0;">
                                ...
                                <a href="https://loopaxis.babluverma.site/contact" style="color: #E6521F; text-decoration: none;">get back on track</a>.
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 20px;">
                            ...
                            <a href="https://loopaxis.babluverma.site/pricing" style="color: #E6521F; text-decoration: none; margin: 0 12px; font-size: 14px;">Pricing</a>
    ...
    `;
        const info = await nodemailer_1.email_transporter.sendMail({
            from: `LoopAxis Automations <${nodemailer_1.sender_email}>`,
            to: email,
            subject,
            html,
        });
