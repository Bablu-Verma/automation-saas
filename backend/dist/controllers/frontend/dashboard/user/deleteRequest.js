...
const user_delete_1 = require("../../../../email/user_delete");
const AccountDeleteRequest = async (req, res) => {
    try {
        ...
        const deactivatedUser = await User_1.default.findByIdAndUpdate(userId, { $set: { status: 'delete_request' } }, // Set the status to inactive
        ...
        await (0, user_delete_1.user_delete_request_email)(deactivatedUser.email, deactivatedUser.name);
