...
export const send_password_reset_email = async (resetLink: string, user_email: string) => {
  ...
  try {
    const subject = "🔒 Password Reset Request -  Taskzeno";
...
<head>
    ...
    <title>Password Reset -  Taskzeno</title>
</head>
                    ...
                    <tr>
                        <td style="padding-bottom: 25px;">
                            <p style="color: #131D4F; font-size: 16px; line-height: 1.6; margin: 0;">
                                We received a request to reset your Taskzeno account password. Click the button below to create a new password.
                            </p>
                        </td>
                    </tr>
