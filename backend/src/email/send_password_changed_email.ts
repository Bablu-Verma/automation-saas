...
export const send_password_changed_email = async (user_email: string) => {
  try {
    const subject = "🔒 Password Changed Successfully -  Taskzeno";
...
<head>
    ...
    <title>Password Changed -  Taskzeno</title>
</head>
                    ...
                    <tr>
                        <td style="padding-bottom: 25px;">
                            <p style="color: #131D4F; font-size: 16px; line-height: 1.6; margin: 0; text-align: center;">
                                This is a confirmation that your taskzeno account password has been successfully updated.
                            </p>
                        </td>
                    </tr>
        ...
        <tr>
            <td bgcolor="#131D4F" style="padding: 30px 20px; border-radius: 0 0 10px 10px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom: 20px;">
                            <a href="https://taskzeno.babluverma.site/security" style="color: #E6521F; text-decoration: none; margin: 0 12px; font-size: 14px;">Security</a>
